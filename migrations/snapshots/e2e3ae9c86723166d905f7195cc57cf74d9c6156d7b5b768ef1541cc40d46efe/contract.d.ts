...
export type StorageHash =
  StorageHashBase<'e2e3ae9c86723166d905f7195cc57cf74d9c6156d7b5b768ef1541cc40d46efe'>;
export type ExecutionHash =
  ExecutionHashBase<'0f5dc63cbbeb62f14ada49712551aef863f10c00680d3ac1373ae07cae2f2068'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Asset: {
      ...
      readonly warrantyExpiry: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly licenseKey: CodecTypes['pg/text@1']['output'] | null;
      readonly licenseExpiry: CodecTypes['pg/timestamptz-string@1']['output'] | null;
    ...
    readonly UserAccount: {
      ...
      readonly status: 'ACTIVE' | 'INACTIVE' | 'LOCKED' | 'SUSPENDED';
...
export type FieldInputTypes = {
  readonly public: {
    readonly Asset: {
      ...
      readonly warrantyExpiry: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly licenseKey: CodecTypes['pg/text@1']['input'] | null;
      readonly licenseExpiry: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly condition: 'EXCELLENT' | 'GOOD' | 'FAIR' | 'DAMAGED';
      readonly status: 'AVAILABLE' | 'ASSIGNED' | 'IN_REPAIR' | 'RETURN_REQUESTED' | 'RETIRED';
...
export namespace Models {
  export type public_Employee = {
    ...
    account: public_UserAccount | null;
    assignments: public_Assignment[];
    returnRequests: public_ReturnRequest[];
    readonly [RelationKeys]?: 'account' | 'assignments' | 'returnRequests';
  };
  export type public_UserAccount = {
    id: CodecTypes['pg/text@1']['output'];
    ...
    lastFailedLoginAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
    ...
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    authAuditLogs: public_AuthAuditLog[];
    employee: public_Employee;
    readonly [RelationKeys]?: 'authAuditLogs' | 'employee';
  };
  export type public_AuthAuditLog = {
    id: CodecTypes['pg/text@1']['output'];
  ...
  export type public_Asset = {
    ...
    warrantyExpiry: CodecTypes['pg/timestamptz-string@1']['output'] | null;
    licenseKey: CodecTypes['pg/text@1']['output'] | null;
    licenseExpiry: CodecTypes['pg/timestamptz-string@1']['output'] | null;
...
export declare const models: {
  public: {
    ...
    UserAccount: Models.public_UserAccount;
    AuthAuditLog: Models.public_AuthAuditLog;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly auth_audit_logs: {
              ...
              indexes: readonly [
                {
                  readonly name: 'auth_audit_logs_accountId_idx_cbfb3085';
                  readonly prefix: 'auth_audit_logs_accountId_idx';
                  readonly columns: readonly ['accountId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'auth_audit_logs_action_idx_cd0d2116';
                  readonly prefix: 'auth_audit_logs_action_idx';
                  readonly columns: readonly ['action'];
                  readonly unique: false;
                },
                {
                  readonly name: 'auth_audit_logs_email_idx_46df9cad';
                  readonly prefix: 'auth_audit_logs_email_idx';
                  readonly columns: readonly ['email'];
                  readonly unique: false;
                },
                {
                  readonly name: 'auth_audit_logs_createdAt_idx_9575dbd7';
                  readonly prefix: 'auth_audit_logs_createdAt_idx';
                  readonly columns: readonly ['createdAt'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'auth_audit_logs';
                    readonly columns: readonly ['accountId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'user_accounts';
                    readonly columns: readonly ['id'];
                  };
                },
              ];
            ...
            readonly user_accounts: {
              columns: {
                ...
                readonly provider: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'CREDENTIALS'>;
                  };
                };
              ...
              indexes: readonly [
                {
                  readonly name: 'user_accounts_email_idx_46df9cad';
                  readonly prefix: 'user_accounts_email_idx';
                  readonly columns: readonly ['email'];
                  readonly unique: false;
                },
                {
                  readonly name: 'user_accounts_role_idx_2c1ddf83';
                  readonly prefix: 'user_accounts_role_idx';
                  readonly columns: readonly ['role'];
                  readonly unique: false;
                },
                {
                  readonly name: 'user_accounts_status_idx_e98638ab';
                  readonly prefix: 'user_accounts_status_idx';
                  readonly columns: readonly ['status'];
                  readonly unique: false;
                },
                {
                  readonly name: 'user_accounts_employeeId_idx_087dd4a6';
                  readonly prefix: 'user_accounts_employeeId_idx';
                  readonly columns: readonly ['employeeId'];
                  readonly unique: false;
                },
              ];
          ...
          readonly valueSet: {
            ...
            readonly AuthProvider: {
              readonly kind: 'valueSet';
              readonly values: readonly ['CREDENTIALS'];
            };
            ...
            readonly UserRole: {
              readonly kind: 'valueSet';
              readonly values: readonly ['EMPLOYEE', 'ADMIN'];
            };
          };
        };
      };
...
> & {
  ...
  readonly roots: {
    ...
    readonly user_accounts: {
      ...
      readonly model: 'UserAccount';
    };
    readonly auth_audit_logs: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'AuthAuditLog';
    };
      ...
      readonly public: {
        readonly models: {
          ...
          readonly AuthAuditLog: {
            ...
            readonly storage: {
              readonly table: 'auth_audit_logs';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
        ...
        readonly enum: {
          ...
          readonly AuthAuditAction: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'ACCOUNT_LOCKED'; readonly value: 'ACCOUNT_LOCKED' },
              { readonly name: 'ACCOUNT_UNLOCKED'; readonly value: 'ACCOUNT_UNLOCKED' },
